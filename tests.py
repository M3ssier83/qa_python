...
class TestAddNewBook:
    ...
    def test_add_new_book(self, collector, book_name, expected_count):
...
class TestFavorites:
    ...
    def test_add_book_in_favorites(self, collector, book_name, expected_favorites):
    ...
    def test_delete_book_from_favorites(self, collector, initial_books, book_to_delete, expected_favorites):
    ...
    def test_get_list_of_favorites_books(self, collector, books, expected_favorites):
        for book in books:
            collector.add_new_book(book)
            collector.add_book_in_favorites(book)
        for book in books:
